...
def checkBulletAlienCol(setting, screen, stats, sb, ship, aliens, bullets):
	...
	if collisions:
		effect = setting.explosionEffect()
		effect.add(ship.center, setting.screenHeight//2)
		effect.draw(screen)
		setting.enemyExplodeSound.play()
